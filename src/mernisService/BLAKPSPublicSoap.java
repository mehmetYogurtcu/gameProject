...
public class BLAKPSPublicSoap
{
    ...
    public BLAKPSPublicSoap(){}

    public BLAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BLAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BLAExtendedSoapSerializationEnvelope envelope= new BLAExtendedSoapSerializationEnvelope(BLAExtendedSoapSerializationEnvelope.VER11);
